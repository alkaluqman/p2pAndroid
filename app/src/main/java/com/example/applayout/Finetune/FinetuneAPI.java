...
public class FinetuneAPI {
     ...
     */
    public static void finetune(String modelFileAbsolutePath, String datasetDirAbsolutePath, int numEpochs, int imgHeight, int imgWidth, int numTrainings) {
        Log.d("FinetuneAPI", "In FinetuneAPI.finetune()");
        try {
            new FinetuneTask(modelFileAbsolutePath, datasetDirAbsolutePath, numEpochs, imgHeight, imgWidth, numTrainings).execute().get();
